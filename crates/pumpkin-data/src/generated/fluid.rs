...
impl Fluid {
    ...
    pub const FLOWING_LAVA: Fluid = Fluid {
        ...
        states: &[
            FluidState {
                ...
                is_empty: false,
                blast_resistance: 100f32,
                block_state_id: BlockStateId::new(120u16).unwrap(),
                is_still: false,
                is_source: false,
                falling: false,
            },
            FluidState {
                ...
                is_empty: false,
                blast_resistance: 100f32,
                block_state_id: BlockStateId::new(119u16).unwrap(),
                is_still: false,
                is_source: false,
                falling: false,
            },
            FluidState {
                ...
                is_empty: false,
                blast_resistance: 100f32,
                block_state_id: BlockStateId::new(118u16).unwrap(),
                is_still: false,
                is_source: false,
                falling: false,
            },
    ...
    pub const fn from_state_id(id: BlockStateId) -> Option<&'static Self> {
        match id.as_u16() {
            ...
            89..=89 => Some(&Fluid::WATER),
            105..=105 => Some(&Fluid::LAVA),
            89..=104 => Some(&Fluid::FLOWING_WATER),
            105..=120 => Some(&Fluid::FLOWING_LAVA),
            _ => None,
        }
    }
