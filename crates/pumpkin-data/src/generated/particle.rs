...
impl Particle {
    ...
    pub const fn from_id(id: u16) -> Option<Self> {
        match id {
            ...
            43u16 => Some(Self::RedPoplarLeaves),
            44u16 => Some(Self::OrangePoplarLeaves),
            45u16 => Some(Self::YellowPoplarLeaves),
            46u16 => Some(Self::TintedLeaves),
            47u16 => Some(Self::SculkSoul),
            48u16 => Some(Self::SculkCharge),
            49u16 => Some(Self::SculkChargePop),
            50u16 => Some(Self::SoulFireFlame),
            51u16 => Some(Self::Soul),
            52u16 => Some(Self::Flash),
            53u16 => Some(Self::HappyVillager),
            54u16 => Some(Self::Composter),
            55u16 => Some(Self::Heart),
            56u16 => Some(Self::InstantEffect),
            57u16 => Some(Self::Item),
            58u16 => Some(Self::Vibration),
            59u16 => Some(Self::Trail),
            60u16 => Some(Self::PauseMobGrowth),
            61u16 => Some(Self::ResetMobGrowth),
            62u16 => Some(Self::ItemSlime),
            63u16 => Some(Self::ItemCobweb),
            64u16 => Some(Self::ItemSnowball),
            65u16 => Some(Self::LargeSmoke),
            66u16 => Some(Self::Lava),
            67u16 => Some(Self::Mycelium),
            68u16 => Some(Self::Note),
            69u16 => Some(Self::Poof),
            70u16 => Some(Self::Portal),
            71u16 => Some(Self::Rain),
            72u16 => Some(Self::Smoke),
            73u16 => Some(Self::WhiteSmoke),
            74u16 => Some(Self::Sneeze),
            75u16 => Some(Self::Spit),
            76u16 => Some(Self::SquidInk),
            77u16 => Some(Self::SweepAttack),
            78u16 => Some(Self::TotemOfUndying),
            79u16 => Some(Self::Underwater),
            80u16 => Some(Self::Splash),
            81u16 => Some(Self::Witch),
            82u16 => Some(Self::BubblePop),
            83u16 => Some(Self::CurrentDown),
            84u16 => Some(Self::BubbleColumnUp),
            85u16 => Some(Self::Nautilus),
            86u16 => Some(Self::Dolphin),
            87u16 => Some(Self::CampfireCosySmoke),
            88u16 => Some(Self::CampfireSignalSmoke),
            89u16 => Some(Self::DrippingHoney),
            90u16 => Some(Self::FallingHoney),
            91u16 => Some(Self::LandingHoney),
            92u16 => Some(Self::FallingNectar),
            93u16 => Some(Self::FallingSporeBlossom),
            94u16 => Some(Self::Ash),
            95u16 => Some(Self::CrimsonSpore),
            96u16 => Some(Self::WarpedSpore),
            97u16 => Some(Self::SporeBlossomAir),
            98u16 => Some(Self::DrippingObsidianTear),
            99u16 => Some(Self::FallingObsidianTear),
            100u16 => Some(Self::LandingObsidianTear),
            101u16 => Some(Self::ReversePortal),
            102u16 => Some(Self::WhiteAsh),
            103u16 => Some(Self::SmallFlame),
            104u16 => Some(Self::Snowflake),
            105u16 => Some(Self::DrippingDripstoneLava),
            106u16 => Some(Self::FallingDripstoneLava),
            107u16 => Some(Self::DrippingDripstoneWater),
            108u16 => Some(Self::FallingDripstoneWater),
            109u16 => Some(Self::GlowSquidInk),
            110u16 => Some(Self::Glow),
            111u16 => Some(Self::WaxOn),
            112u16 => Some(Self::WaxOff),
            113u16 => Some(Self::ElectricSpark),
            114u16 => Some(Self::Scrape),
            115u16 => Some(Self::Shriek),
            116u16 => Some(Self::EggCrack),
            117u16 => Some(Self::DustPlume),
            118u16 => Some(Self::TrialSpawnerDetection),
            119u16 => Some(Self::TrialSpawnerDetectionOminous),
            120u16 => Some(Self::VaultConnection),
            121u16 => Some(Self::DustPillar),
            122u16 => Some(Self::OminousSpawning),
            123u16 => Some(Self::RaidOmen),
            124u16 => Some(Self::TrialOmen),
            125u16 => Some(Self::BlockCrumble),
            126u16 => Some(Self::Firefly),
            127u16 => Some(Self::SulfurCubeGoo),
            _ => None,
        }
    }
    #[must_use]
